...
class Component_one extends React.Component {
 ...
 nextWindow(){
   window.location.replace(
     "https://thecovidcentral.herokuapp.com/"
   );
 }
      ...
      <div className="component_one">
        ...
        <h5 class = "userWarning">The Following Information Has Been Extracted From a Washington Post Article written by Kanyakrit Vongkiatkajorn and Laura Daily</h5>
          <table class = "myTable">
            ...
            <tr>
              <td class = "donationTableOrgName">CDC Foundation</td>
              ...
              <td class = "donationTableOrgLink"><a href = "https://give.cdcfoundation.org/give/269833/#!/donation/checkout">DONATE HERE</a></td>
            </tr>
            <tr>
              <td class = "donationTableOrgName">Center for Disaster Philanthropy Covid-19 Response Fund</td>
              ...
              <td class = "donationTableOrgLink"><a href = "https://disasterphilanthropy.org/donate-to-the-cdp-covid-19-response-fund/">DONATE HERE</a></td>
            </tr>
            <tr>
              <td class = "donationTableOrgName">Direct Relief</td>
              ...
              <td class = "donationTableOrgLink"><a href = "https://www.directrelief.org/">DONATE HERE</a></td>
            </tr>
            <tr>
              <td class = "donationTableOrgName">Feeding America</td>
              ...
              <td class = "donationTableOrgLink"><a href = "https://www.feedingamerica.org/">DONATE HERE</a></td>
            </tr>
            <tr>
              <td class = "donationTableOrgName">No Kid Hungry</td>
              ...
              <td class = "donationTableOrgLink"><a href = "https://secure.nokidhungry.org/site/Donation2?17586.donation=form1&df_id=17586&mfc_pref=T">DONATE HERE</a></td>
            </tr>
            <tr>
              <td class = "donationTableOrgName">American Red Cross</td>
              ...
              <td class = "donationTableOrgLink"><a href = "https://www.redcrossblood.org/give.html/find-drive">DONATE HERE</a></td>
            </tr>
          </table>
          ...
          <hr class = "lineTag"></hr>
        <div>
          <h2>User Suggested Organizations -- USERS</h2>
        ...
        <table class = "myTable">
          ...
          <tr key = {corona_stats.Organization}>
              <td class = "donationTableOrgName">{corona_stats.Organization}</td>
              <td>{corona_stats.Description}</td>
              <td class = "donationTableOrgLink"><a href = {corona_stats.Links}>DONATE HERE</a></td>
          </tr>)}
        </table>
        <br/>
        <hr class = "lineTag"></hr>
        ...
        <button id = "button" onClick={() => {this.nextWindow()}}>Go Back to News and Updates!</button>
        <p class = "creatorSignature">Created by Ashray Wadhwa</p><br/>
